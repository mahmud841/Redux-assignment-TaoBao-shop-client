      ...
      <Container className="py-5 animate__animated animate__fadeInDownBig">
        ...
        <div className="add-service-form shadow-lg mt-4">
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            />
            {errors.title && (
              <span className="text-danger">Title is compulsory</span>
            )}
            <input
              type="text"
            ...
            />
            {errors.description && (
              <span className="text-danger">Description is compulsory</span>
            )}
            <input
              type="number"
              placeholder="Price"
            ...
            />
            {errors.price && (
              <span className="text-danger">Price is compulsory</span>
            )}
            ...
            {errors.img && (
              <span className="text-danger">Image is needed</span>
            )}
